 ...
 <div class="w3-container" style="padding-top:22px">
     ...
     <?php
      if(isset($_POST['submit']))
      {
      	...
      	$insert_query = $db->query("INSERT INTO quarantine(livestockno,breed,reason,date_q)VALUES('$livestockno','$n_breed','$n_remark','$now') ");

      	if($insert_query){?>
      	<div class="alert alert-success alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Livestock successfully quarantined <i class="fa fa-check"></i></strong>
        </div>
       <?php
         header('refresh: .5');
      	}else{ ?>
          <div class="alert alert-danger alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Error inserting livestock data. Please try again <i class="fa fa-times"></i></strong>
        </div>
      	<?php
      }
     ...
     ?>
	 		...
	 		<form role='form' method="post">
	 			<div class="form-group">
	 				...
	 				<input type="text" name="livestockno" readonly="on" class="form-control" value="<?php echo $livestockno; ?>">
	 			</div>
